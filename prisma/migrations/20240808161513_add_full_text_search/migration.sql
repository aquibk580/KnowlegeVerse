...
-- your generated SQL will be here

-- Add this line to create a full-text index on the "title" column
CREATE INDEX course_title_fulltext_idx ON "Course" USING GIN (to_tsvector('english', title));
